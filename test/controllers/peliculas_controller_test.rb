...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post peliculas_url, params: { pelicula: { actor_principal: @pelicula.actor_principal, descripcion: @pelicula.descripcion, duracion: @pelicula.duracion, titulo: @pelicula.titulo } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { actor_principal: @pelicula.actor_principal, descripcion: @pelicula.descripcion, duracion: @pelicula.duracion, titulo: @pelicula.titulo } }
